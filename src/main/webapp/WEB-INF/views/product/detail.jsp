		...
		<div class="proForm">
			...
			<span class="pro pro2">
				...
				<section class="buy">
					...
					<button style="border-radius: 0.375rem;"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16" style="padding: 5;">
